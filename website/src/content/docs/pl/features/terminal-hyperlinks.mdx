...
<Aside type="tip">
  Jesli wystepuja problemy z renderowaniem terminala, mozesz wylaczyc hiperlinki ustawiajac `hyperlinks = false` w konfiguracji lub pomijajac flage `--hyperlinks`.
</Aside>
