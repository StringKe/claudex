...
<Aside type="tip">
  Wenn Probleme mit der Terminal-Darstellung auftreten, koennen Sie Hyperlinks mit `hyperlinks = false` in Ihrer Konfiguration oder durch Weglassen des `--hyperlinks`-Flags deaktivieren.
</Aside>
