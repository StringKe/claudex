...
<Aside type="caution">
  Las funciones del motor de contexto requieren un servicio LLM para la generacion de resumenes y embeddings. Puedes usar cualquier perfil existente (Ollama local, proveedores en la nube como OpenRouter, etc.).
</Aside>
...
4. La conversacion comprimida se reenvfa al proveedor
