...
<Aside type="tip">
  Si experimentas problemas con el renderizado del terminal, puedes deshabilitar los hipervinculos con `hyperlinks = false` en tu configuracion o omitiendo el flag `--hyperlinks`.
</Aside>
