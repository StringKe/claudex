...
6. La solicitud se reenvfa al proveedor seleccionado
...
| `analysis` | Analisis de datos y razonamiento | Analizar registros, comparar enfoques, explicar conceptos |
...
| `math` | Tareas matematicas y logicas | Calcular complejidad, demostrar corrección |
