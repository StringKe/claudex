...
上下文引擎透過三種機制增強您的 AI 互動：對話壓縮、跨 profile 上下文共享，以及本地 RAG（檢索增強生成）。

<Aside type="caution">
  上下文引擎功能需要 LLM 服務進行摘要生成和嵌入向量生成。您可以使用任何現有 profile（本地 Ollama、雲端提供商如 OpenRouter 等）。
</Aside>
