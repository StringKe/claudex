...
| `temperature`, `top_p`, `stop_sequences` | Direct mapping |
...
| OpenRouter | DirectAnthropic | `https://openrouter.ai/api` |
...
<Aside type="tip">
  DirectAnthropic providers require no translation — requests are forwarded directly with updated headers and base URL.
</Aside>
