...
<Aside type="tip">
  Si vous rencontrez des problemes de rendu du terminal, vous pouvez desactiver les hyperliens avec `hyperlinks = false` dans votre config ou en omettant le flag `--hyperlinks`.
</Aside>
